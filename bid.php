...
<head>
	...
	<meta charset="UTF-8">
   	...
   	<title>eAuction Homepage</title>
		...
		<h1><I>Make a bid!</I></h3>

      <form action='bid.php' method='post'>
        <div class="container">
          Enter new bid:<br>
       <input type="text" placeholder="Enter Bid" name="name" required>
...
$category = $_SESSION['category'];
    $bid = filter_input(INPUT_POST, 'name');
    $userInfo =  "INSERT INTO Bid (bidprice, itemname, category)
    VALUES ('$bid', '$itemname', '$category');";

    if (mysqli_query($connect, $userInfo)) {
      echo "";
    } else {
      echo "Error: " .$userInfo ."<br>" .mysqli_error($conn);
		...
		$sql1 = "SELECT auctionid FROM AuctionItems WHERE category = 'GA';";
