...
<head>
	...
	<meta charset="UTF-8">
   	...
   	<title>eAuction Homepage</title>
		...
		$sql1 = "SELECT auctionid FROM AuctionItems WHERE category = 'ND';";
		...
		$sql1 = "SELECT auctionid FROM AuctionItems WHERE category = 'NC';";
		$result = mysqli_query($connect,$sql1);
		$total_rows = mysqli_num_rows($result);
		$is_correct = 0;
		$is_count = 0;
