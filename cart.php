...
<head>
	...
	if($_SESSION['accountholder']==$comp){
	  echo "
	    <!DOCTYPE html>
	    <html lang=\"en\">
	    <head>
	    ...
	    <div class=\"alert alert-danger\">
			...
			<h3>Company is not a buyer</h3>
	    </div>";

	    header("refresh:3;//localhost/practice/user.html");
	}
	else{
	  $dbhost = "localhost";
	  ...
	  $get_cart = "SELECT * FROM Cart where email='$email';";

	  $is_correct = mysqli_query($connect, $get_cart);
	  $count = 0;
	...
	*/		//$cprice = $currow['buyitnow'];
			print "<img src=\"https://assets.academy.com/mgen/61/20057861.jpg\" width=\"250px\" height=\"250px\"\ />";
			//echo $curitem;
			//echo $cprice;
...
//	}
	...
	?>
<p><a href="card.html">Proceed to checkout</a></p>
	<meta charset="UTF-8">
    	<link rel="stylesheet" type="text/css" href="indexStyle.css">
    	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
