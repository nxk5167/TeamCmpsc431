...
<head>
	...
	<meta charset="UTF-8">
   	...
   	<title>eAuction Homepage</title>
		...
		<h1><I>Literature and Fiction Books</I></h3>
		...
		$sql1 = "SELECT auctionid FROM AuctionItems WHERE category = 'LA';";
		...
		$sql1 = "SELECT auctionid FROM AuctionItems WHERE category = 'ME';";
		$result = mysqli_query($connect,$sql1);
		$total_rows = mysqli_num_rows($result);
		$is_correct = 0;
		$is_count = 0;
